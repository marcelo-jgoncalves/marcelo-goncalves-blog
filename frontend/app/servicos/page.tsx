  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="Criamos sistemas, plataformas e aplicações sob medida para automatizar processos, integrar operações e apoiar o crescimento da sua empresa."
        right={
          <>
            ...
            <div className="svc-hero-actions svc-hero-actions-mobile">
              <a className="btn svc-btn-clay-hero" href="#contato">Entre em contato</a>
            </div>
          </>
        }
        statsStrip={
      ...
      >
        <div className="svc-hero-actions svc-hero-actions-desktop">
          <a className="btn svc-btn-clay-hero" href="#contato">Entre em contato <span className="svc-arrow">→</span></a>
        </div>
      </PageHero>
