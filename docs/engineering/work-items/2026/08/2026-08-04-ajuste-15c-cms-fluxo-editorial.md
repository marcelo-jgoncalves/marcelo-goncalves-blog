---
id: WORK-2026-004
title: Ajuste 15C - CMS e Fluxo Editorial
...
execution_agent:
scope: ["CMS admin", "fluxo editorial"]
related_audits: []
related_cases: []
related_commits: []
...
- Status: blocked
- Data: 2026-08-04 (última confirmação de status)
- Commit: nenhum específico deste ajuste completo
- Pull request: nenhuma
- Arquivos alterados: nenhum ainda
- Critérios satisfeitos: não aplicável (bloqueado)
- Critérios não satisfeitos: escopo completo do CMS/fluxo editorial ainda não implementado
- Desvios em relação à instrução original: nenhum registrado
- Decisões humanas adicionais: deferido para o backend por decisão de Marcelo (ver `memory/project_ajuste15_backlog.md`), sem migração de taxonomia de categorias nem scoring real de relacionados/destaque/bastidores
- Documentação canônica resultante: nenhuma ainda
