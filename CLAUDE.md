...
9. **Testes E2E Playwright** — expandir cobertura: post individual, artigos, busca, categoria. **Avaliado em 2026-08-02**: escopo real é grande (4 rotas, cada uma com fluxos próprios — paginação, busca com termo vazio/sem resultado, filtro de categoria) — não cabe como item de passagem numa sessão com vários outros itens; tratar como sessão própria dedicada.
